export function threesWin(data: any, playerData: any, msg: string) {
  ...
  let msg1 = `<:green_triangle:966364916548255874>\`${playerData.player.displayname}\` [Overall] \`${Math.floor((data.player.player.stats.Bedwars.final_kills_bedwars / data.player.player.stats.Bedwars.final_deaths_bedwars)*10)/10} → ${Math.floor((playerData.player.stats.Bedwars.final_kills_bedwars / playerData.player.stats.Bedwars.final_deaths_bedwars)*10)/10}\` [Threes] \`${Math.floor((data.player.player.stats.Bedwars.four_three_final_kills_bedwars / data.player.player.stats.Bedwars.four_three_final_deaths_bedwars)*10)/10} → ${Math.floor((playerData.player.stats.Bedwars.four_three_final_kills_bedwars / playerData.player.stats.Bedwars.four_three_final_deaths_bedwars)*10)/10}\``;
